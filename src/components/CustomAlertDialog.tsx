...
export function CustomAlertDialog({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in" onClick={handleCancel}>
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
        ...
        className="relative w-full max-w-md bg-[var(--color-sidebar)] border border-[var(--color-border)] rounded-2xl shadow-2xl flex flex-col animate-fade-in-up"
